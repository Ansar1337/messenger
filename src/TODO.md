...
5. [x] Визуальное разлечения бабблов (sender,receiver)
...
Изменил у левого хвостика его левый и правый border для соответсвия общей стилистики c правым хвостиком

// Пофиксить отоброжения времени и контента сообщений в соответсвии с общей стилистикой (пример: телеграмм)

bubble-overlay -> bubble-message -> sender-avatar